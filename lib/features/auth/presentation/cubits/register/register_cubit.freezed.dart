...
abstract class $RegisterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({RegisterStatus status, ErrorObject? error});
}
...
class _$RegisterStateImpl implements _RegisterState {
  const _$RegisterStateImpl({required this.status, required this.error});
...
abstract class _RegisterState implements RegisterState {
  const factory _RegisterState(
      ...
      required final ErrorObject? error}) = _$RegisterStateImpl;
