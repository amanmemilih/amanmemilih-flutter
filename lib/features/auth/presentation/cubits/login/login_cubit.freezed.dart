...
abstract class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({LoginStatus status, ErrorObject? error, bool isPasswordHidden});
}
...
class _$LoginStateImpl implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(status: $status, error: $error, isPasswordHidden: $isPasswordHidden)';
  }
...
abstract class _LoginState implements LoginState {
  const factory _LoginState(
      ...
      required final bool isPasswordHidden}) = _$LoginStateImpl;
